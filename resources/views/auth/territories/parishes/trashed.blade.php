...
<div class="row align-items-center">
    <div class="col-md-6">
        <div class="mb-3">
            <h4 class="card-title">{{ __('Parishes_Trashed_Table') }}</h4>
        </div>
    </div>
        ...
        var table = $('.data-table').DataTable({
            ...
            buttons: [{
                    ...
                    action: function(e, dt, node, config) {
                        window.location = "{{ route('parish.create') }}";
                    },
                    className: 'btn-info',
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        var url = "{{ route('parish.restore', ':data') }}";
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        window.location = "{{ route('parish.trashed') }}";
                    },
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        window.location = "{{ route('parish.index') }}";
                    },
                    className: 'btn-primary',
                },
                'colvis'
