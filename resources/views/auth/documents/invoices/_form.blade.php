                ...
                <table class="table table-nowrap">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div>
                                    <input class="form-control required" placeholder="Enter Name" type="text">
                                </div>
                            </td>
                            <td>
                                <div>
                            ...
                            <td>
                                <div class="text-center">
                                    <a href="#" class="text-danger p-2 d-inline-block" data-toggle="tooltip"
            ...
            <div class="row justify-content-end">
                <div class="col-xl-3 col-md-4">
                    <div>
                        ...
                        <div>
                            <h5 class="font-size-14 py-2">Discount : <span class="float-end fw-normal text-body"> -
                                    0.00</span></h5>
                        </div>
                        <div>
                        ...
                        <div>
                            <h5 class="font-size-14 py-2">Tax : <span class="float-end fw-normal text-body">
                                    0.00</span></h5>
                        </div>
                        <div>
