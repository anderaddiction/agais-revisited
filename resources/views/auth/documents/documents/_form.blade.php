...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" placeholder="{{ __('Enter Acronym') }}" name="acronym" id="acronym"
                value="{{ old('acronym', $document->acronym) }}">
            <div class="pristine-error text-danger">{{ $errors->first('acronym') }}</div>
        </div>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-12">
        <div class="mb-3">
            ...
            <textarea class="form-control" name="note" id="note" cols="30"
                rows="5">{{ old('note', $document->note) }}</textarea>
        </div>
    </div>
</div>
