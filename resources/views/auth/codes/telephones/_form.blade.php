...
<div class="row">
    <div class="col-md-4">
        <div class="mb-3">
            ...
            <input type="text" class="form-control required" placeholder="{{ __('Enter phone code') }}" name="phone_code" id="phone_code"
    ...
    <div class="col-md-4">
        <div class="mb-3">
            ...
            <div class="pristine-error text-danger" id="country_idError" style="margin-top: -6%">{{ $errors->first('country_id') }}</div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="mb-3">
