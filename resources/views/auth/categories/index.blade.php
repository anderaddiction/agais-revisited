...
<div class="row align-items-center">
    <div class="col-md-6">
        <div class="mb-3">
            <h4 class="card-title">{{ __('Category_Table') }}</h4>
        </div>
    </div>
        ...
        var table = $('.data-table').DataTable({
            ...
            buttons: [{
                ...
                },
                {
                    ...
                    action: function() {
                        var fileSelector = $(
                            '<input type="file" name="file" data-route="{{ route('category.import') }}" title="Importar">'
                        );
                        fileSelector.click();
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        window.location = "{{ route('category.trashed') }}";
                    },
