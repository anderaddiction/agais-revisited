...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="mb-3">
            ...
            <input type="text" class="form-control required" placeholder="{{ __('Enter symbol') }}" name="symbol" id="symbol"
    ...
    <div class="col-md-4">
        <div class="mb-3">
            ...
            <input type="text" class="form-control required" placeholder="{{ __('Enter ISO') }}" name="iso" id="iso"
...
<div class="row">
    <div class="col-md-6">
        <div class="mb-3">
            ...
            <div class="pristine-error text-danger" id="Error" style="margin-top: -4%">{{ $errors->first('country_id') }}</div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="mb-3">
