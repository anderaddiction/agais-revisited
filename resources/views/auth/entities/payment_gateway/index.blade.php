...
<div class="row align-items-center">
    <div class="col-md-6">
        <div class="mb-3">
            <h4 class="card-title">{{ __('Payment_Gateway_Table') }}</h4>
        </div>
    </div>
...
<script type="text/javascript">
    $(function() {
        var table = $('.data-table').DataTable({
            ...
            responsive: true,
            pageLength: 20,
            ajax: "{{ route('payment_gateway.index') }}",
            dom: 'Bfrtip',
            columns: [{
                    data: 'id',
                    name: 'id',
            ...
            buttons: [{
                    ...
                    action: function(e, dt, node, config) {
                        window.location = "{{ route('payment_gateway.create') }}";
                    },
                    className: 'btn-info',
                },
                {
                    ...
                    action: function() {
                        var fileSelector = $(
                            '<input type="file" name="file" data-route="{{ route('payment_gateway.import') }}" title="Importar">'
                        );
                        fileSelector.click();
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        var url = "{{ route('payment_gateway.destroy', ':data') }}";
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        window.location = "{{ route('payment_gateway.trashed') }}";
                    },
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        window.location = "{{ route('payment_gateway.index') }}";
                    },
