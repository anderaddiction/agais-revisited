...
<div class="row align-items-center">
    <div class="col-md-6">
        <div class="mb-3">
            <h4 class="card-title">{{ __('Urbanism_Trashed_Table') }}</h4>
        </div>
    </div>
        ...
        var table = $('.data-table').DataTable({
            ...
            buttons: [{
                    ...
                    action: function(e, dt, node, config) {
                        window.location = "{{ route('urbanism.create') }}";
                    },
                    className: 'btn-info',
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        var url = "{{ route('urbanism.restore', ':data') }}";
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        window.location = "{{ route('urbanism.trashed') }}";
                    },
                ...
                },
                {
                    ...
                    action: function(e, dt, node, config) {
                        window.location = "{{ route('urbanism.index') }}";
                    },
                    className: 'btn-primary',
                },
                'colvis'
